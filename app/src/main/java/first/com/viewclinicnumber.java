            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < Array.length(); i++) {
                        ...
                        int item0 = (int) itemDivision.get(0);
                        r_data.add(item0+"");
    ...
    private void printData(){
        ...
        division.add("皮膚科");
         ...
         for(int i=0;i<r_data.size()/6;i++){
            ...
            if(division.size()!=0){
                String num=r_data.get(j);
                int n=Integer.parseInt(num)-1;
                tt0.setText(division.get(n));
            }
            else
                tt0.setText(r_data.get(j));
                    ...
                    case "科別":
                        btn1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if(!content.isEmpty()){
                                    int index=division.indexOf(content);
                                    Resources res=getResources();
                                    LinearLayout ll0=new LinearLayout(viewclinicnumber.this);
                                    ll0.setOrientation(LinearLayout.VERTICAL);
                                    ll0.setBackground(res.getDrawable(R.drawable.rectangle_blue));
                                    TextView tt0=new TextView(viewclinicnumber.this);
                                    tt0.setText(division.get((index/6)%division.size()));
                                    tt0.setTextColor(Color.WHITE);
                                    //r_data.remove(0);
                                    tt0.setTextSize(32);
                                    tt0.setGravity(Gravity.CENTER);
                    ...
                    case "病人姓名":
                        btn1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if(!content.isEmpty()){
                                    int index=r_data.indexOf(content);
                                    int n=index-2;
                                    Resources res=getResources();
                                    LinearLayout ll0=new LinearLayout(viewclinicnumber.this);
                                    ll0.setOrientation(LinearLayout.VERTICAL);
                                   ...
                                   /* for(int i=0;i<r_data.size();i++){
                                    ...
                                    /*if(patient.size()==1){
                                        ...
                                        ll0.setBackground(res.getDrawable(R.drawable.rectangle_blue));
                                        TextView tt0=new TextView(viewclinicnumber.this);
                                        tt0.setText(r_data.get(index-2));
                                        tt0.setTextColor(Color.WHITE);
                                        //r_data.remove(0);
                                        tt0.setTextSize(32);
                                        tt0.setGravity(Gravity.CENTER);
                                        ...
                                        for(int i=0;i<patient.size();i++){
                                            ...
                                            ll0.setBackground(res.getDrawable(R.drawable.rectangle_blue));
                                            TextView tt0=new TextView(viewclinicnumber.this);
                                            tt0.setText(r_data.get(patient.get(i)-2));
                                            tt0.setTextColor(Color.WHITE);
                                            //r_data.remove(0);
                                            tt0.setTextSize(32);
                                            tt0.setGravity(Gravity.CENTER);
                                            ...
                                            ll4.setMinimumWidth(200);
                                            TextView tt2=new TextView(viewclinicnumber.this);
                                            tt2.setText(r_data.get(patient.get(i)-1));
                                            tt2.setTextColor(Color.GREEN);
                                            //r_data.remove(0);
                                            tt2.setTextSize(28);
                                            ll4.addView(tt2);
                                            ...
                                            ll7.setMinimumWidth(200);
                                            TextView tt4=new TextView(viewclinicnumber.this);
                                            tt4.setText(r_data.get(patient.get(i)));
                                            tt4.setTextColor(Color.GREEN);
                                            //r_data.remove(0);
                                            tt4.setTextSize(28);
                                            ll7.addView(tt4);
                                            ...
                                            ll10.setMinimumWidth(200);
                                            TextView tt6=new TextView(viewclinicnumber.this);
                                            tt6.setText(r_data.get(patient.get(i)+1));
                                            tt6.setTextColor(Color.GREEN);
                                            //r_data.remove(0);
                                            tt6.setTextSize(28);
                                            ll10.addView(tt6);
                                            ...
                                            ll13.setMinimumWidth(200);
                                            TextView tt8=new TextView(viewclinicnumber.this);
                                            tt8.setText(r_data.get(patient.get(i)+2));
                                            tt8.setTextColor(Color.GREEN);
                                            //r_data.remove(0);
                                            tt8.setTextSize(28);
                                            ll13.addView(tt8);
                                            ...
                                            ll16.setMinimumWidth(200);
                                            TextView tt10=new TextView(viewclinicnumber.this);
                                            tt10.setText(r_data.get(patient.get(i)+3));
                                            tt10.setTextColor(Color.GREEN);
                                            //r_data.remove(0);
                                            tt10.setTextSize(28);
                                            ll16.addView(tt10);
